        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-secondary max-w-4xl mx-auto">
              Each Billberry Blue project is a reflection of refined taste, thoughtful design, 
              and meticulous execution. Our portfolio showcases a curated selection of spaces 
              designed with intention and elegance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-secondary text-base md:text-lg">
                Custom-designed homes that balance comfort, sophistication, and functionality 
                tailored to reflect personal style and lifestyle needs.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-secondary text-base md:text-lg">
                Purpose-driven designs that elevate brands and enhance user experience across 
                offices, studios, and hospitality environments.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-secondary text-base md:text-lg">
                Elegant event designs crafted to create memorable experiences through cohesive 
